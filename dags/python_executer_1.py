...
with DAG(
    ...
    preprocess = DatabricksSubmitRunOperator(task_id='spark_python_task_preprocess', 
                                                ...
                                                spark_python_task={
                                                    'python_file' :'dbfs:/Workspace/Shared/cicd_harry/jobs/preprocess/preprocess.py'
                                                    }
                                                )
    ...
    train = DatabricksSubmitRunOperator(task_id='spark_python_task_train', 
                                                new_cluster= new_cluster,
                                                spark_python_task={
                                                    'python_file' :'dbfs:/Workspace/Shared/cicd_harry/jobs/train/train.py'
                                                    }
                                                )
